	...
	<div class="container">
            ...
            if ($themo_footer_widget_switch === "on"){ ?>
                ...
                if ( is_active_sidebar('sidebar-footer-1') ) {?>
                    <div class="footer-area-1 <?php echo $bootstrap_footer_column_class; ?>">
                    <?php dynamic_sidebar('sidebar-footer-1'); ?>
                    </div>
                <?php } ?>
                <?php // Footer column 2
                if ( is_active_sidebar('sidebar-footer-2') ) {?>
                    <div class="footer-area-2 <?php echo $bootstrap_footer_column_class; ?>">
                    <?php dynamic_sidebar('sidebar-footer-2'); ?>
                    </div>
                <?php } ?>
                 <?php // Footer column 3
                if ( is_active_sidebar('sidebar-footer-3') ) {?>
                    <div class="footer-area-3 <?php echo $bootstrap_footer_column_class; ?>">
                    <?php dynamic_sidebar('sidebar-footer-3'); ?>
                    </div>
                <?php } ?>
                 <?php // Footer column 4
                if ( is_active_sidebar('sidebar-footer-4') ) {?>
                    <div class="footer-area-4 <?php echo $bootstrap_footer_column_class; ?>">
    ...
    <div class="footer-btm-bar">        
        <div class="container">    
            <div class="footer-copyright row">
                <div class="col-xs-12">
                    <p><?php echo $themo_footer_copyright_output ;?> <?php echo $themo_footer_spacer;?> <?php echo $themo_footer_credit_output;?></p>
                </div>
            </div>
        </div>
    </div>
