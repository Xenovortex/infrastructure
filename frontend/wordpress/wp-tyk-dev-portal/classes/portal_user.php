...
class Tyk_Portal_User 
{
	 ...
	 * @return void
	 */
	public function save_access_token($api_id, $token_name, $hash, $key) {
		$data = array(
	...
	public function get_tyk_id() {
		PC::debug(get_user_meta($this->user->ID, self::META_TYK_USER_ID_KEY, true));
